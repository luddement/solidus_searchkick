Spree::Taxon.class_eval do
  ...
  Rails.application.config.after_initialize do
    ...
    searchkick index_name: "#{Rails.application.class.parent_name.parameterize.underscore}_spree_taxons_#{Rails.env}", word_start: [:name] unless Spree::Taxon.try(:searchkick_options)
  end
